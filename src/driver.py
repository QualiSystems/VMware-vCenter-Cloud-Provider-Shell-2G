...
from cloudshell.cp.core.request_actions import DeployedVMActions  # noqa
from cloudshell.cp.core.request_actions import GetVMDetailsRequestActions  # noqa
...
class VMwarevCenterCloudProviderShell2GDriver(ResourceDriverInterface):
    ...
    def Deploy(self, context, request, cancellation_context=None):
        ...
        with LoggingSessionContext(context) as logger:
            ...
            deploy_flow = VCenterDeployVMfromVMFlow(
                resource_config=resource_config,
    ...
    def PowerOn(self, context, ports):
        ...
        with LoggingSessionContext(context) as logger:
            ...
            api = CloudShellSessionContext(context).get_api()  # noqa
