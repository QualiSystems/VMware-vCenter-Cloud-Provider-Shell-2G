...
class VMwarevCenterCloudProviderShell2GDriver(ResourceDriverInterface):
    ...
    def customize_guest_os(
        self, context, ports, custom_spec_name, custom_spec_params, override_custom_spec
    ):
        return self.command_orchestrator.customize_guest_os(
            context, custom_spec_name, custom_spec_params, override_custom_spec
        )
