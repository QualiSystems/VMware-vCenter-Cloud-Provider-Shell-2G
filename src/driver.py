...
class VMwarevCenterCloudProviderShell2GDriver(ResourceDriverInterface):
    ...
    def __init__(self):
        ...
        self.deployments['VMware vCenter Cloud Provider 2G.vCenter VM From VM 2G'] = self.deploy_clone_from_vm
        self.deployments['VMware vCenter Cloud Provider 2G.vCenter VM From Linked Clone 2G'] = self.deploy_from_linked_clone
        self.deployments['VMware vCenter Cloud Provider 2G.vCenter VM From Template 2G'] = self.deploy_from_template
        self.deployments['VMware vCenter Cloud Provider 2G.vCenter VM From Image 2G'] = self.deploy_from_image
